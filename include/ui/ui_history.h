...
/* Undo and redo interfaces for table editing operations. */
...
/* Describes the cursor position to restore after replaying a history action. */
typedef struct {
    int ok;
...
/* Replay or refresh history state. */
